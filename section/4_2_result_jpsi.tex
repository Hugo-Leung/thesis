...
\begin{figure}[h!]
	...
	\end{subfigure}
	\caption{Mass fit for the first $P_T$ bin ($0\leq P_T<0.3$) for both \ce{LH_2} (left) and \ce{LD_2} (right) targets
		and both run 2-3 (top) and run 5-6 (bottom). }
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.8\linewidth]{cs/full_data/pdpp_CSR_full.pdf}
