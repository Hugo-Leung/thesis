...
\begin{table}[ht!]
	...
	\begin{tabular}{|m{4.5cm}|m{7cm}|m{3cm}|}
		...
		$\chi^2_{dimuon}$                                                                                   & $\chi^2$ when both $\mu^+$ and   $\mu^-$ tracks are forced to pass through dimuon vertex & $<18$                          \\ \hline
...
\begin{itemize}
	...
	\item \SI{99.99}{\percent} pure commercial deuterium which is used in later half of the experiment.
\end{itemize}
\begin{table}[h!]
	\centering
	\caption{Summary of \ce{LD_2} contamination with the mole fraction of each source of contamination}
...
\begin{equation}
	Y_{\text{cont.~\ce{LD_2}}} = N_A P_D X_D \epsilon_D \left( T_D^D \sigma_{pd}/A_D + T^D_H \sigma_{pp}/A_H   \right).
\end{equation}
...
\begin{equation}
	\begin{split}
		V_{\text{eff.}}&=\frac{N_{\ce{HD}} V_{\ce{HD}} + N_{\ce{D_2}} V_{\ce{D_2}}}{N_{tot}}\\
		&=V_{D_2} \left[ C \frac{V_{\ce{HD}}}{V_{\ce{D_2}}} + (1-C) \right]\\
		&=V_{D_2} f,
	\end{split}
\end{equation}
where $f=\left[ C \frac{V_{\ce{HD}}}{V_{D_2}} + (1-C) \right]$.
The total number of molecules per area is
\begin{equation}
	\begin{split}
		\frac{N_{\text{tot.}}}{\text{Area}} &= \frac{L}{V_{eff}}\\
...
\begin{equation}
	\begin{split}
		T_D^D &= \frac{N_D A_D}{A} = A_D\frac{N_{\text{tot.}}}{\text{Area}} \left[ 2(1-C) + C \right]\\
...
\begin{equation}
	\begin{split}
		T^D_H &= \frac{N_H A_H}{A} = A_H\frac{N_{\text{tot.}}}{\text{Area}}C\\
...
\begin{equation}
	\begin{split}
		\rho_{\text{eff.}} &= \frac{1}{L} (T_D^H + T_D^D)\\
...
\begin{equation}
	\begin{split}
		\frac{1}{\lambda_{\text{eff.}}} &= \frac{1}{L\rho_{\text{eff.}}} \left[\frac{T_D^H}{\lambda_H} +\frac{T_D^D}{\lambda_D}\right]\\
...
\begin{equation}
	\frac{\sigma_{pd}}{2\sigma_{pp}} = \frac{Y_{\ce{LD_2}}}{2Y_{\ce{LH2}}}\frac{A_D}{A_H}\frac{T_H^H P_H X_{H} \epsilon_H}{T_D^D P_D X_{\text{eff}} \epsilon_D} - \frac{T^D_H}{2T_D^D} \frac{A_D}{A_H}
\end{equation}
