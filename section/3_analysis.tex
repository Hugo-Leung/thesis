...
The annihilating quark and antiquark would also form the quark plane, which can be offset from the
hadron plane.
...
We also utilize Apptainer (formerly known as Singularity)~\cite{kurtzer2021} to maintain better control of the
runtime environment.
