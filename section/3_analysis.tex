...
At each iteration, the Kalman filter loops over all the nodes. Using the current estimate of the track parameters
from the previous node, the expected hit location location is calculated using Geant4. This predicted location
...
Once all the nodes have been predicted and filtered, the smoothing step can begin. This step propagates
