...
will produce more hits in the detector.

\begin{figure}[h!]
\centering
\includegraphics[width=0.5\linewidth]{placeholder}
\caption{The D2 occupancy profile for \ce{LH_2} and \ce{LD_2} for run 5-6 after event selection. Both histogram are normalized to unit area.
}
\label{fig:target_D2}
\end{figure}
