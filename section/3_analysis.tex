...
\begin{figure}[h!]
	...
	\input{images/Collins_Soper_frame.tex}
...
from different targets can also be combined to increase statistics. For this study, the \ce{LH_2}
...
\begin{figure}[h!]
	...
	\begin{subfigure}{0.45\linewidth}
		\includegraphics[width=\linewidth]{deadtime/run5ea_deadtime_LH2_repair}
	\end{subfigure}
	\begin{subfigure}{0.45\linewidth}
		\includegraphics[width=\linewidth]{deadtime/run5ea_deadtime_LD2_repair}
	\end{subfigure}
	\caption{The measured deadtime per event for \ce{LH_2} (left) and \ce{LD_2} (right) data from Run 5.}
	\label{fig:deadtime}
\end{figure}
...
\begin{equation}
	...
	\label{eq:TF_d2}
\end{equation}
\Cref{eq:TF_d2} can be simplified and rewritten as
\begin{equation}
...
\begin{figure}[h!]
	...
	\caption{The St.~2 occupancy profile for \ce{LH_2} and \ce{LD_2} for runs 5-6 after event selection. Both histograms are normalized to unit area.
	}
	\label{fig:target_D2}
\end{figure}
...
\begin{table}[h!]
	\centering
	\caption{Summary of \ce{LD_2} contamination, taken from Ref.~\cite{paul-1893}}
...
which corresponds to model fractions of \SI{91.6}{\percent} \ce{D_2} and \SI{8.4}{\percent} \ce{HD}.
...
\begin{figure}[h!]
	...
	\end{subfigure}
	\caption{The extracted $p1$ from \ce{LH_2} (left) and \ce{LD_2} (right) data as a function
...
decay. The number of  \ce{^{24}Na} nuclei is deduced by counting the number of \SI{1369}{\keV} photons
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.8\linewidth]{scale/dy_cs0_d.pdf}
