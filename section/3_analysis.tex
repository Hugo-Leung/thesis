...
extract the $p1$ parameter in each bin. The extracted $p1$ is shown in \cref{fig:pq_xF_LD2_DY},
...
\begin{figure}[h!]
	...
	\label{fig:pq_xF_LD2_DY}
\end{figure}

For the charmonium decays, the $P_T$ distribution is extracted in a iterative process, and the $p1$
parmeters are taken from the extracted $P_T$ distribution in \pdfcomment{which section}
