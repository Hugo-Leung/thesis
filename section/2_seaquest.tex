...
in a \SI{50.8}{\cm} cylindrical vacuum vessel, with a diameter of \SI{3.81}{\cm}.
In the case of liquid targets, the proton beam would also traverse through two
\SI{140}{\um} thick windows on both ends of the vacuum vessel and the \SI{51}{\mu} end caps.
