...
SeaQuest data taking, the are five output triggers, as listed in Table.~\ref{tab:FPGA}.
...
of the reconstruction. This will be discussed further in Sec.~\ref{M-sec:MC}.
