...
\pdfmargincomment{Should there be a dedicated section on the spectrometer?
	how much detail od the spetrometer is need?
}
...
passing through the radiator, into a signle photomultiplier tube. The signal is then
...
integrated beam instensity for entire spill; (b) integrated beam while inhibit is 
aserted at tigger logic; (c) integrated intensity during deadtime; (d) a snapshot 
of the beam intensity flose in time to the trigger; and (e) a complete record of the
bucket-bucket instensity for the entire spill.
