...
\pdfcomment{Should there be a dedicated section on the spectrometer?}
...
\section{Beam}
\pdfcomment{A brief description of the beam structure, how the beam intensity 
is monitor. And finally says that the varying instantaneous beam intensity 
allows us to do intensity extrapolation which will be discussed in next chapter
}

\section{Target}
\pdfcomment{list the properties of the targets. Some past thesis quoted the
