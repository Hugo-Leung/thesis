...
The primimary purpose of the scintillator hodoscopes are are to provide fast singal for 
trigger system. the x-palnes are place vertically to measure the bend plane Position.
And the y-planes are arranged horizontally to measure the non-bend plane.

Station 1 and 2 each have single x-y planes. Station 3 ahs a single x plane, and station
4 has two y planes and one x plane. The station 4 hodoscopes have PMTs on both ends of the 
sintillator bars. The configuration of the hodoscope is summariezed in Table.~\ref{table:hodo}.
\pdfmargincomment{why are there 2 y hodo in St4? Lower rate at St4? Shivangi's thesis is correct NIM paper is wrong}
\begin{table}[h!]
