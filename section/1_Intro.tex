...
As the LDMEs discribes the hadronization process, which a non-pertubative affect,
...
The other LDMEs are typically obtained by fitting to data and assumed to
be universal, independent of beam or target hadrons and the energy scale. Some
existing LDMEs for direct $J/\psi$ production are tabulated in \cref{tab:LDMEs}.
