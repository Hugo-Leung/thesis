...
\begin{equation}
	\ket{p} = \sqrt{Z}\ket{p_0} + \sum_{MB}\int \dd{y} \dd[2]{\vec{k}_\perp} \phi_{BM} \left(y, \vec{k}_\perp\right)\ket{B\left(y, \vec{k}_\perp\right);M\left(1-y, -\vec{k}_\perp\right)}
\end{equation}
...
$\vec{k}_\perp$ and $-\vec{k}_\perp$ respectively.
...
is emitted from the valence quarks.
\begin{equation}
