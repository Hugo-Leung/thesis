...
bound together through the exchange of gluons. One key feature of QCD is ``asymptotic freedom'':
...
In this regime perturbation theory clearly fails. 
...
Although enormous progress have made in lattice QCD calculations, they are limited
...
\begin{equation}
	\expval{r^2}=-6\eval{\dv{G_E\left(Q^2\right)}{Q^2}}_{Q^2=0}.
\end{equation}
...
\begin{equation}
	\begin{split}
		...
		&+\frac{1}{2}\ket{\uparrow\uparrow\downarrow-\downarrow\uparrow\uparrow}\ket{uud-duu}\Bigl\} \frac{\sqrt{2}}{3}.
	\end{split}
\end{equation}
...
For example, from the number of valence quarks in the protons,
...
the sea-quark distribution exhibit a valence like behavior, but is overwhelm by the perturbative
...
The SeaQuest measurement covers a broader kinematic range of $0.4<x_F<0.95$ at a lower beam energy
of \SI{120}{\GeV}.
...
different groups are very different, in some cases, even the signs are different.
