...
\Cref{fig:CSR_Run2-3} shows the extracted cross section ratio as a function of $x_B$
...
\input{table/extrapolate/run23.tex}
\end{table}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.6\linewidth]{DY-csr/run56-xT_all}
...
the difference in the acceptance. \pdfmargincomment{show how the acceptance is different}
...
\centering
\caption{The reduced $\chi^2$ for the different fits used in the intensity extrapolation method. }
\input{table/extrapolate/run56.tex}
\end{table}
...
\pdfcomment{Should I show the JAM or CJ22 result instead? Their result shows a comparison before and after SeaQuest}
