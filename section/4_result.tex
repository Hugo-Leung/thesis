...
with different experiments. The statistical and systematic uncertainties are summed together for each data point. The data points are also fitted to the following form, taken from \pdfcomment{citation!!!!!}
\begin{equation}
