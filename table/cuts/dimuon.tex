\begin{table}[ht!]
	...
	\begin{tabular}{|m{4.5cm}|m{7cm}|m{3cm}|}
		...
		$dpx^2+dpy^2$                                                                                                                     & transverse momentum squared of   dimuon                                                  & $<\SI{5}{\GeV\squared}$        \\ \hline
		dpz                                                                                                                               & dimuon z momentum                                                                        & (\SI{38}{\GeV},\SI{116}{\GeV}) \\ \hline
		$|\mathrm{trackSeparation}|$                                                                                                      & distance in z between points   of  closest approach between $\mu^+$   and $\mu^-$ tracks & $<\SI{270}{\cm}$               \\ \hline
		...
		$y_3(\mu^+) \times y_3(\mu^-)$                                                                                                    & product of the y positions at St.~3 for both tracks                                                      & $<0$                           \\ \hline
		$\mathrm{nHists}(\mu^+)+\mathrm{nHists}(\mu^-)$                                                                                   & sum of the total number of hits on wire chamber by $\mu^+$ and $\mu^-$ tracks             & $>29$                          \\ \hline
		$\mathrm{nHists}_1(\mu^+)+\mathrm{nHists}_1(\mu^-)$                                                                               & sum of the total number of hits on St.~1 wire chamber by $\mu^+$ and $\mu^-$ tracks       & $>8$                           \\ \hline
		$|x_1(\mu^+) + x_1(\mu^-)|$                                                                                                       & sum of x position of tracks   at St.~1                                               & $>\SI{42}{\cm}$                \\ \hline
	\end{tabular}
\end{table}
