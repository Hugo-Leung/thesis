...
\begin{abstract}
	...
	section from SeaQuest are presented and compared with theoretical predictions.
	The Drell-Yan cross section ratio is extracted from the entire SeaQuest dataset
	using two independent methods. And the ratio is found to remain about unity,
	indicating the $\bar{d}>\bar{u}$ for $x$ up to \num{0.45}.
	The charmonium production cross sections are also founded to be in good agreement with
